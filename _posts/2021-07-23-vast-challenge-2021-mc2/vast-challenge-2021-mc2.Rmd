...
```{r q3f1, fig.cap="Multiple matched pairs", code_folding="Q3-Fig1", fig.width=8}
# filter multiple match
card_correspond_count_others <- card_correspond_count %>%
  filter(n_distinct(last4ccnum)>1 | n_distinct(loyaltynum)>1)
...
```{r q3f2, fig.cap="Long and short car stop", code_folding="Q3-Fig2"}
...
```{r , eval=FALSE, echo=FALSE, code_folding="Mannual work"}
