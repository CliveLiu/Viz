...
```{r q1f3, fig.height=6, fig.cap="Daily Consumption Amount of Credit Card (box plot)", code_folding="Q1-Fig3 Code"}
...
The right heatmaps also show anomalies: A very high consumption amount ($32419.63) happened at 11 o'clock of "Stewart and Sons Fabrication".
...
```{r , eval=FALSE, echo=FALSE, code_folding="Codes for mannual work"}
