...
```{r q3f1, layout="l-body-outset", fig.cap="", code_folding="Q1-Fig1"}
1
```
```{r q3f2, layout="l-body-outset", fig.cap="", code_folding="Q1-Fig1"}
1
```
```{r q3f3, layout="l-body-outset", fig.cap="", code_folding="Q1-Fig1"}
1
```
...
```{r q4f1, layout="l-body-outset", fig.cap="", code_folding="Q1-Fig1"}
1
```
```{r q4f2, layout="l-body-outset", fig.cap="", code_folding="Q1-Fig1"}
1
```
```{r q4f3, layout="l-body-outset", fig.cap="", code_folding="Q1-Fig1"}
1
```

### Q5: Identify locations where might be suspicious activity with evidence
```{r q5f1, layout="l-body-outset", fig.cap="", code_folding="Q1-Fig1"}
1
```
```{r q5f2, layout="l-body-outset", fig.cap="", code_folding="Q1-Fig1"}
1
```
```{r q5f3, layout="l-body-outset", fig.cap="", code_folding="Q1-Fig1"}
1
```
