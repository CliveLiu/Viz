...
plotly::subplot(ggplotly(p1_price),
  ...
  layout(annotations = 
           list(x = 0.02 , y = 1.06, 
                text = "Hourly Frequency of Credit and Loyalty Card Usage",
                showarrow = F, xref='paper', yref='paper'))
```
...
And there are many outliers which might be anomalies. For example, "Frydos Autosupply n' More" had a daily consumption amount in day 13 which is several times as much as those in other days.
